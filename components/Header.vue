<template>
  <header class="bg-gray-800 text-white py-4 px-8 flex justify-between items-center">
    ...
    <nav class="hidden md:flex items-center space-x-4">
      ...
      <router-link to="/john" active-class="border-teal-300 border-b-2" class="hover:text-teal-300">
        John
      </router-link>
      ...
      <router-link to="/ida" active-class="border-teal-300 border-b-2" class="hover:text-teal-300">
        The Mascot
      </router-link>
      <router-link to="/about" active-class="border-teal-300 border-b-2" class="hover:text-teal-300">
        About
      </router-link>
      <a href="https://github.com/nora2605/jane" target="_blank" rel="noopener noreferrer">
        <svg class="w-6 h-6 hover:text-teal-300" viewBox="0 0 24 24" fill="white">
          <path
